  ...
  <div className="gpt3__possibility section__padding" id="about">
    ...
    <div className="gpt3__possibility-content">
      ...
      <p>As a life long busy body , before tech I gave 8 years to healthcare and home health. I later started a 3d printing buisness
         for surgeons in my community. Bringing tech and visual aspects of life to help solve problems can be a magical and impactful combination. Learning 
         full stack development was an unexpected path I fell in love with when I decided to reskill myself for a new path in my life.
