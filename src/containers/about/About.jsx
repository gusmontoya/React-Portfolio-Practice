  ...
  <div className="gpt3__possibility section__padding" id="possibility">
    ...
    <div className="gpt3__possibility-content">
      ...
      <p>I'm passionate about  bringing both the technical and visual aspects of digital products to life. 
          ...
          <a className="anchorLink" href="https://youtu.be/7EmboKQH8lM" target="_blank" rel="noreferrer" aria-label="open link to Clean Code - Uncle Bob."> principles of clean code</a>,
      ...
      <p>I'm happiest when I'm creating, learning, exploring and thinking about how to make things better. Currently solving deceptively simple problems on 
          ...
          <a className="anchorLink" href="https://chingu.io/" target="_blank" rel="noreferrer" aria-label="open link to chingu's website."> chingu</a> and Discord.
      </p>
